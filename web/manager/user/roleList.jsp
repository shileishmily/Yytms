                    ...
                    $("#maingrid").ligerGrid({
                        ...
                        columns: [
                            ...
                            {display: '创建时间', name: 'createtime', minWidth: 140},
                            {
                                ...
                                align:"center",
                                render:function(obj){
                                    var result = "<div class='operating'><a class='ui-icon ui-icon-pencil' title='修改' href='javascript:updateData("+obj.id+")'></a><a class='ui-icon ui-icon-trash' title='删除' href='javascript:delData(\""+obj.id+"\",2)'></a></div>";
                                    return result;
                                }
                            }
                        ],
                        ...
                        toolbar: {
                            items: [
                                {text: '增加', click: addData, icon: 'add'},
                                {line: true},
                                {text: '修改', click: updateData, icon: 'modify'},
                                {line: true},
                                {text: '删除', click: delData, img: 'resources/ligerUI/skins/icons/delete.gif'},
                                {line: true},
                                {text: '设置栏目', click: setModule, icon: 'modify'},
                                {line: true},
                                {text: '设置用户', click: setUser, icon: 'modify'},
