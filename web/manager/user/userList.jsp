    ...
    <script type="text/javascript">
        ...
        $(function () {
            window['g'] = $("#maingrid").ligerGrid({
                ...
                checkbox: true,
                columns: [
                    {display: '姓名', name: 'userName', align: 'left', width: 100, minWidth: 60},
                    ...
                    {display: '冻结状态', name: 'userFreezeFlag'},
                    {
                        ...
                        align:"center",
                        render:function(obj){
                            var result = "<div class='operating'><a class='ui-icon ui-icon-pencil' title='修改' href='javascript:updateData("+obj.userLoginName+")'></a><a class='ui-icon ui-icon-trash' title='删除' href='javascript:delData(\""+obj.userLoginName+"\",2)'></a></div>";
                            return result;
                        }
                    }
                ],
        ...
        * @param position 1-工具栏点删除；2-行上点删除
         */
        function delData(rowid,position) {
            var returnValue = "";
        ...
        * @param position
         */
        function resetPwdData(rowid,position) {
            var returnValue = "";
            var rows = g.getSelecteds();
